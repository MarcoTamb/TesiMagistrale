...
\end{align*}
Using a similar line of reasoning for $\nu_{(X_t+\varepsilon u_t)}$ to only keep the highest order terms, using \ref{Weingarten2} and the fact that in it there are no higher order terms,  and letting $\varepsilon\rightarrow 0$, we get to: 
