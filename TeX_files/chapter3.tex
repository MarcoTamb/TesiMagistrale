...
Throughout the chapter, by hyperplane we mean a totally geodesic hypersurface. 
...
\begin{defin}
	...
	\begin{itemize}
		...
		\item  At all $x\in X(M^n) \cap \pi$ the normal vectors to the $X$ and $X^\pi$ do not coincide (which would also imply that $T_xX= T_xX^\pi$). 
	\end{itemize} 
\end{defin}
This fundamentally means that the reflection of one of the halves of $X$ on the other side of $\pi$ is contained in the region inside $M^n$ and the tangent spaces of $X$ and of the half-reflection do not coincide unless $X$ and the half-reflection are tangent at that point.   
\begin{defin}
